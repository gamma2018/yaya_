...
public class NoteFraisGridAdapter extends BaseAdapter{

    Context c;
    int layout;
    ArrayList<HistoriqueItem> items;

    public NoteFraisGridAdapter(Context c, int layout, ArrayList<HistoriqueItem> items) {
        this.c = c;
        this.layout = layout;
        this.items = items;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            TextView libelleProduit = (TextView) gridV.findViewById(R.id.libelleNoteFrais);
            TextView montant = (TextView) gridV.findViewById(R.id.montant);
            TextView codeProd = (TextView) gridV.findViewById(R.id.codeNote);
