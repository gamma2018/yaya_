...
public class AddFamille extends AsyncTask<Void, Void, Boolean> {
    private FamilleProduit mFamilleProduit;
    private ProgressDialog pD;
    Context c;


    public AddFamille(FamilleProduit familleProduit, ProgressDialog pD, Context c) {
        mFamilleProduit = familleProduit;
        this.pD = pD;
        this.c = c;
    }
    ...
    protected Boolean doInBackground(Void... voids) {
        new Model().addFamille(mFamilleProduit);
