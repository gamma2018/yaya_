...
public class AddProduit extends AsyncTask<Void, Void, Boolean> {
    Produit mProduit;
    ProgressDialog pD;
    Context c;
    private ArrayList<Produit> lProd = new ArrayList<Produit>();

    public AddProduit(Produit produit, ProgressDialog pD, Context c) {
        mProduit = produit;
        this.pD = pD;
        this.c = c;
    }
    ...
    protected Boolean doInBackground(Void... voids) {
        new Model().addProduit(mProduit);
        lProd = new Model().getAllProduit();
        return true;
    }
    ...
    protected void onPreExecute() {
        ...
        pD.setMessage("Veillez patienter traitement en cours.");
        pD.show();
    }
    ...
    protected void onPostExecute(Boolean aBoolean) {
        ...
        if(aBoolean) {
            Partager.setListeProuits(lProd);
            pD.dismiss();
