...
public class ReimpressionGridAdapter extends BaseAdapter{

    Context c;
    int layout;
    ArrayList<HistoriqueItem> items;

    public ReimpressionGridAdapter(Context c, int layout, ArrayList<HistoriqueItem> items) {
        this.c = c;
        this.layout = layout;
        this.items = items;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            TextView codeProd = (TextView) gridV.findViewById(R.id.venteCode);
