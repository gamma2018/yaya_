...
public class AddGrossiste extends AsyncTask<Void, Void, Boolean> {
    private Grossiste mGrossiste;
    private ProgressDialog pD;
    Context c;


    public AddGrossiste(Grossiste grossiste, ProgressDialog pD, Context c) {
        mGrossiste = grossiste;
        this.pD = pD;
        this.c = c;
    }
    ...
    protected Boolean doInBackground(Void... voids) {
        new Model().addGrossiste(mGrossiste);
